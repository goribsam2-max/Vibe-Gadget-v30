  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        align="end"
        sideOffset={12}
        className="w-64 rounded-3xl border border-white/50 dark:border-white/10 bg-white/70 dark:bg-black/70 backdrop-blur-2xl backdrop-saturate-[1.5] shadow-[0_16px_40px_-12px_rgba(0,0,0,0.15),inset_0_1px_1px_rgba(255,255,255,0.4)] dark:shadow-[0_16px_40px_-12px_rgba(0,0,0,0.3),inset_0_1px_1px_rgba(255,255,255,0.1)] p-2 z-[9999] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-4"
      >
        {!user ? (
          <>
